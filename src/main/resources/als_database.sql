...
INSERT INTO `courses` (`id`, `name`, `description`, `rating`, `user_count`, `level`) VALUES (2,'Введение в JavaScript',NULL,3.1,2,1),(5,'Введение в HTML и CSS',NULL,4.9,1,1),(6,'HTML5',NULL,1.7,3,2),(7,'Python.Начало','Приветствую Вас на курсе!\\nВ этом курсе мы разберем множество классных технологий, станем гуру программирования (нет), а также будем пробовать светоч среди технологий в образовании - адаптивное обучение!\\nУдачи, и да прибудет с вами Python! И адаптивное обучение конечно.',3.5,5,1),(8,'Python.Продолжение','',4.1,1,2),(9,'Основы jQuery',NULL,2.8,0,2);
...
INSERT INTO `tests_questions` (`id`, `question_id`, `test_id`) VALUES (1,2,1),(2,3,1),(3,4,1),(4,5,1),(5,6,1),(6,7,1),(7,8,1),(8,9,1),(9,10,1),(10,11,1),(11,12,1),(12,13,1),(13,14,1),(14,15,1),(15,16,1),(16,17,1),(17,18,1),(18,19,1),(19,20,1),(20,21,1),(21,22,1),(22,23,1);
...
-- Dump completed on 2017-05-14 23:14:17
